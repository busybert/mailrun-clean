...
const Pricing = () => {
  ...
  // ⭐ NEW — server-compatible Stripe Checkout handler
  const handleCheckout = async (e) => {
    ...
    try {
      ...
      // ⭐ AMAZON ONE-TIME PICKUP → $4.99 after coupon
      if (selectedService === "payPerPickup") {
        itemsToCheckout = [
          {
            price: "price_1SSv372E8UrZzRbdvB2HJ4VA", // Amazon one-time price
            quantity: 1,
      ...
      // ⭐ SUBSCRIPTION — your Stripe subscription IDs go here
