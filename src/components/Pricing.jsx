    ...
    try {
      ...
      if (selectedService === "payPerPickup") {
        await redirectToCheckout({
          mode: "payment",
          lineItems: [{ price: "price_1SSv372E8UrZzRbdvB2HJ4VA", quantity: 1 }],
          discounts: [{ coupon: "promo_1SXn5y2E8UrZzRbd9Hmr2Ri8" }],
      ...
      // ⭐ STANDARD — $4.99 After Coupon
      if (selectedService === "standard") {
        await redirectToCheckout({
          mode: "payment",
          lineItems: [{ price: "price_1SP72n2E8UrZzRbdz5FncYGG", quantity: 1 }],
          discounts: [{ coupon: "promo_1SXn0h2E8UrZzRbdsy0JGJT8" }],
          successUrl: window.location.origin + "/success",
          cancelUrl: window.location.origin + "/cancel",
        });
        return;
      ...
      if (selectedService === "rush") {
        await redirectToCheckout({
          mode: "payment",
          lineItems: [{ price: "price_1SP73c2E8UrZzRbdVEqSv5SM", quantity: 1 }],
          successUrl: window.location.origin + "/success",
          cancelUrl: window.location.origin + "/cancel",
        });
        return;
          ...
          lineItems: [
            {
              price:
                billingPeriod === "annual"
                  ? "price_1SSv6e2E8UrZzRbdVqkqKeFi" // $199 yearly
                  : "price_1SSv5K2E8UrZzRbdVdPlsu9T", // $19.99 monthly
              quantity: 1,
            },
          ],
          successUrl: window.location.origin + "/success",
    ...
    >
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <motion.p
            animate={{ rotate: [-8, 8, -8], scale: [1, 1.35, 1] }}
