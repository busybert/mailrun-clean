  ...
  if (error || !product) {
    return (
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center text-red-400 p-8 bg-slate-800/50 rounded-2xl">
  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-8 bg-slate-800/50 backdrop-blur-sm p-8 rounded-2xl border border-slate-700/50">
